...
void initTextures() {
	int width, height;
	unsigned char* image = SOIL_load_image("C:\\Users\\Sanjiv\\Desktop\\container.jpg", &width, &height, 0, SOIL_LOAD_RGB);
	if (0 == image) {
		std::cout << "error";
...
void storeData() {
	//glm::mat4 camera;
	//camera = glm::lookAt(glm::vec3(0.0f, 0.0f, -2.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
